...
import com.takehome.stayease.security.model.exchange.ChangePasswordRequest;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        var user = Users.builder()
                ...
                .build();
        if(user.getRole()==null)user.setRole(Role.CUSTOMER); // this was not being done , that caused nullpointer exception 
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        Users user = repository.findByEmail(request.getEmail()).orElseThrow(()->new RuntimeException("User with email id "+ request.getEmail()+" not found"));
        String jwtToken = jwtService.generateToken(user); // using var is risky , it may cause unknown issues
